package com.example.widgets_displaydatafromrssfeed;
...
public class NewsService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(ApplicationClass.connectionAvailable(getApplicationContext())) {
            ...
            RemoteViews views = new RemoteViews("com.example.widgets_displaydatafromrssfeed",
                    R.layout.new_app_widget);
            views.setTextViewText(R.id.tvTitle, "Getting news headline...");
            views.setTextViewText(R.id.tvDescription, "Getting news description...");
            ...
            Toast.makeText(getApplicationContext(), "No internet. Please try again later.", Toast.LENGTH_SHORT).show();
            stopSelf();
        }
    ...
    public class GetStoriesInBackground extends AsyncTask<Integer, Integer, String>
    {
        ...
        protected void onPostExecute(String result) {
            ...
            // when the user clicks on refresh/sync button
            PendingIntent pendingIntentSync = PendingIntent.getActivity(getApplicationContext(), 0,
